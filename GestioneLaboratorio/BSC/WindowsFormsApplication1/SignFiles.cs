...
namespace SignRTFPDF
{
    public class SignFiles
    {
        ...
        public static bool bNotificaCapocommessa = false;
        ...
        public static int KnoS_IdActionPDLFirmatoCERT = 0;
        ...
        public static bool LoadInfoXML(string fileInfoXML)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (nInfo.Attributes.GetNamedItem("NotificaCapocommessa") != null)
                    {
                        bool.TryParse(nInfo.Attributes["NotificaCapocommessa"].Value.ToString(), out bNotificaCapocommessa);
                    }
                }
