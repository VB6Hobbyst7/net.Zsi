...
namespace ItaCalendar.ZSIDataSetTableAdapters {
...
SELECT ID, Summary, Start, [End], RecurrenceRule, MasterEventId, Location, Description, BackgroundId FROM Appointments WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ItaCalendar.Properties.Settings.Default.ZSIConnectionString;
        }
        ...
        public virtual int Fill(ZSIDataSet.AppointmentsDataTable dataTable) {
        ...
        public virtual ZSIDataSet.AppointmentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
